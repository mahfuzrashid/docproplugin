<?php
/**
 * Clinic Details - Nav Item Overview Section - Services
 *
...
<div class="accordion-box">
    ...
    <div class="title-box">
        <h6><?php printf( '%s<span>%s</span>', esc_html__( 'Offered Services', 'docpro' ), esc_html__( 'Price', 'docpro' ) ); ?></h6>
    </div>

	<?php if ( ! empty( $clinic->services ) ) : ?>
        <ul class="accordion-inner">
			<?php foreach ( $clinic->services as $index => $service ) : ?>

<?php
/**
 * Dashboard - Clinic Change Password
 */
...
if ( wp_verify_nonce( docpro()->get_args_option( 'docpro_pw_nonce_val', '', $posted_data ), 'docpro_pw_nonce' ) ) {
	...
	if ( wp_check_password( $old_password, $clinic->user_pass, $clinic->ID ) && $new_password == $confirm_password ) {
		wp_set_password( $new_password, $clinic->ID );

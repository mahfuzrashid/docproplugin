		...
		function generate_gallery( $option ) {
            ...
            <script>
                jQuery(document).ready(function ($) {
                    ...
                    $('#media_upload_<?php echo $field_id; ?>').click(function () {
                        ...
                        wp.media.editor.send.attachment = function (props, attachment) {
                            ...
                            $('#media_preview_<?php echo $field_id; ?>').append(html);
                        }
					...
					<?php if( $sorting ) : ?>
                        $(function () {
                            $('#media_preview_<?php echo $field_id; ?>').sortable({
                                handle: 'img',
                                revert: false,
                                axis: "x",
                            });
            ...
            <style>
                #media_preview_<?php echo $field_id; ?> > div {
                ...
                #media_preview_<?php echo $field_id; ?> > div:hover span {
                    display: block;
                }

                #media_preview_<?php echo $field_id; ?> > div > span {
                    display: none;
                    cursor: pointer;
                    background: #ddd;
                    padding: 2px;
                ...
                #media_preview_<?php echo $field_id; ?> > div > img {
                    width: 100%;
                    cursor: move;
                }
            </style>
